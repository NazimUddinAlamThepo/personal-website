          ...
          >
            {filtered.map((p, i) => (
              <motion.article
                ...
                className="glass-card project-card rounded-2xl overflow-hidden flex flex-col"
              >
                {/* Card top color bar */}
                <div className={`h-1.5 w-full ${p.color === 'forest'
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  {/* Title */}
                  <h3 className="font-semibold text-base text-[var(--color-text)] mb-2 leading-snug">{p.title}</h3>
