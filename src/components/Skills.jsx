      ...
      <div className="container-narrow">
        ...
        {inView && (
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {/* ML stack + languages + soft skills */}
            <div className="space-y-6">
              ...
              <div className="glass-card rounded-2xl p-7">
                ...
                {skills.certifications.map(c => (
                  <div key={c.name} className="flex items-start gap-3 mb-3 last:mb-0">
                    <span className="mt-1 w-2 h-2 rounded-full bg-navy-500 dark:bg-navy-300 shrink-0" />
                    <div>
